  ...
  head: () => ({
    meta: [
      { title: "Driver Support — 24/7 Help for Yango Drivers | Yango Wing Fleet" },
      {
        name: "description",
        content:
          "Get 24/7 support for app issues, account help, onboarding questions and more. Real human help on WhatsApp, call, and in-office.",
      },
...
const CATEGORIES = [
  ...
  { icon: MapPin, t: "Map & Navigation", d: "GPS, location accuracy, or routing issues." },
  {
    icon: AlertCircle,
    t: "Account Issues",
    d: "Blocked account, payment delays, or earnings questions.",
  },
];
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container-x pt-20 pb-12 text-center">
          ...
          <h1 className="mt-6 text-4xl md:text-6xl font-bold tracking-tight">
            We're <span className="text-gradient-primary">always here.</span>
          </h1>
          <p className="mx-auto mt-5 max-w-2xl text-base md:text-lg text-muted-foreground">
            Real humans, real fast. Reach us anytime through WhatsApp, phone or visit our office.
          </p>
        </div>
      </section>
      ...
      <section className="container-x py-12 grid gap-6 md:grid-cols-3">
        <Reveal>
          <a
            ...
            className="group block glass rounded-2xl p-6 hover:border-gold transition-all hover:-translate-y-1"
          >
            <MessageCircle className="h-8 w-8 text-gold" />
            <h3 className="mt-4 text-xl font-bold">WhatsApp Help</h3>
            <p className="mt-2 text-sm text-muted-foreground">
              Fastest response time. Average under 2 minutes.
            </p>
