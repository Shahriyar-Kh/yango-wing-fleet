  ...
  head: () => ({
    meta: [
      { title: "Services — Bike, Car & Rickshaw Yango Registration | Yango Wing Fleet" },
      {
        name: "description",
        content:
          "Free Yango driver registration for bikes, cars and rickshaws across Pakistan. Step-by-step onboarding with 24/7 support.",
      },
      { property: "og:title", content: "Yango Registration Services — Bike, Car, Rickshaw" },
      {
        property: "og:description",
        content: "Free onboarding with Yango Wing Fleet — quick, trusted and 100% online.",
      },
    ],
  }),
    ...
    <>
      <section className="relative overflow-hidden">
        ...
        <div className="container-x pt-20 pb-12 text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base md:text-lg text-muted-foreground">
            Choose your vehicle type and get onboarded with Yango through Pakistan's most trusted
            partner.
          </p>
        </div>
      </section>
              ...
              <article className="glass-strong rounded-3xl p-8 md:p-12 hover:border-gold transition-colors">
                <div className="grid gap-10 lg:grid-cols-[1fr_2fr]">
                  <div>
                    ...
                    <Link
                      to="/registration"
                      className="mt-6 inline-flex items-center gap-2 rounded-full bg-gradient-primary px-5 py-3 text-sm font-bold text-primary-foreground shadow-glow hover:scale-105 transition-transform"
                    >
                      ...
                      <ol className="mt-4 space-y-3">
                        {s.steps.map((step, idx) => (
                          <li key={step} className="flex items-start gap-3 text-sm">
                            <span className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-gradient-primary text-xs font-bold text-primary-foreground">
                              {idx + 1}
                            </span>
                            {step}
                          </li>
      ...
      <section className="container-x pb-24">
        <SectionTitle
          ...
          subtitle="Talk to our team — we'll help you pick the right path in minutes."
        />
        <div className="mt-8 text-center">
          <Link
            to="/contact"
            className="inline-flex items-center gap-2 rounded-full bg-gradient-gold px-6 py-3.5 text-sm font-bold text-gold-foreground shadow-gold-glow"
          >
